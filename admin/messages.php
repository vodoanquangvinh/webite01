...
<div class="box-container">
   ...
   <p> Địa chỉ email: <span><?= $fetch_message['email']; ?></span></p>
   <p> Số điện thoại: <span><?= $fetch_message['number']; ?></span></p>
   <p> Tin nhắn: <span><?= $fetch_message['message']; ?></span></p>
   <a href="messages.php?delete=<?= $fetch_message['id']; ?>" onclick="return confirm('Bạn có chắc chắn xóa tin nhắn này không?');" class="delete-btn">xóa</a>
   </div>
   <?php
         }
      }else{
