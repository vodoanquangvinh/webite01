...
<section class="accounts">
   ...
   <div class="box">
      ...
      <a href="users_accounts.php?delete=<?= $fetch_accounts['id']; ?>" onclick="return confirm('khi xóa tài khoản này những thông tin liên quan cũng sẽ bị xóa')" class="delete-btn">xóa</a>
   </div>
   <?php
         }
      }else{
