...
<section class="contact">
   ...
   <form action="" method="post">
      ...
      <input type="text" name="name" placeholder="nhập họ và tên" required maxlength="20" class="box">
      <input type="email" name="email" placeholder="nhập địa chỉ email" required maxlength="50" class="box">
