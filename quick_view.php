      ...
      <div class="row">
         ...
         <div class="content">
            ...
            <div class="flex-btn">
               ...
               <input type="submit" value="yêu thích sản phẩm" class="option-btn" name="add_to_wishlist">
            </div>
            <div class="flex-btn">
               <a href="view_post.php?get_id=<?= $post_id; ?>" class="option-btn">xem đánh giá về sản phẩm</a>
            </div>
         </div>
      </div>
   </form>
